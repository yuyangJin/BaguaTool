...
analysis.setStaticAnalysisMode(mode="binary", binary="./gmx_mpi")
...
for np in nps:
    ...
    analysis.setExecutionCommand(cmd="srun -n " + str(np) + " -w gorgon[7,8] ./gmx_mpi mdrun -v -s stmv.tpr -nsteps 2000 -resetstep 1800", output_file_suffix="_np-" + str(np))

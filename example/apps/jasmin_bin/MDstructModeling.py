...
analysis.setStaticAnalysisMode(mode="binary", binary="./moleculardynamics-main2d", func="updateparticles_")
...
func_node = bgt.getNodeWithUniqueId(psg.main_root, 552809, random.randint(0,100000))

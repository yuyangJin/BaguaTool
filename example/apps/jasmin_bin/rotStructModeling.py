...
analysis.setStaticAnalysisMode(mode="binary", binary="./rotadv-main2d")
...
nps = [32]
patch_size_xs = [512, 128, 64, 16, 4]
patch_size_ys = [512, 128, 64, 16, 4]
...
for np in nps:
    for patch_size_x in patch_size_xs:
        for patch_size_y in patch_size_ys:
            X_input_parameter.append([patch_size_x, patch_size_y])
            X_input_parameter_new.append([patch_size_x, patch_size_y])
...
def nodeModeling(node):
    ...
    if (node.type_name == "LOOP" or node.type_name == "CALL" ) and node.performance_percentage > 0.0:
        ...
        for np in nps:
            for patch_size_x in patch_size_xs:
                for patch_size_y in patch_size_ys:
                    index = "_np" + str(np) + "-psx" + str(patch_size_x) + "-pxy" + str(patch_size_y)
...
func_node1 = bgt.getNodeWithUniqueId(psg.main_root, 553522, random.randint(0, 100000))
print(func_node1.type_name, func_node1.name)
func_node2 = bgt.getNodeWithUniqueId(psg.main_root, 553795, random.randint(0, 100000))
print(func_node2.type_name, func_node1.name)
func_node3 = bgt.getNodeWithUniqueId(psg.main_root, 554315, random.randint(0, 100000))
print(func_node3.type_name, func_node1.name)
func_node4 = bgt.getNodeWithUniqueId(psg.main_root, 554969, random.randint(0, 100000))
print(func_node4.type_name, func_node2.name)
...
psg.BFS(func_node4, getFuncList)
print(func_list)
...
total_y_tot_cyc_1 = []
psg.BFS(func_node4, nodeModeling)
#print(total_y_tot_cyc_1)
...
psg.BFS(func_node4, nodePerformancePrediction)
...
program_time4 = programPerformancePrediction(func_node4)
print(program_time1)
print(program_time2)
print(program_time3)
print(program_time4)

...
analysis.setStaticAnalysisMode(mode="binary", binary="./clover_leaf") 
...
nps = [24]
for np in nps:
    analysis.setExecutionCommand(cmd="srun -N 2 -n " + str(np) + " ./clover_leaf", output_file_suffix="_np" + str(np) )

# set
analysis.setOutputDir(output_dir="cloverleaf-baguatool-data")

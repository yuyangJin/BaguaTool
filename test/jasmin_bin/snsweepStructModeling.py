...
analysis.setStaticAnalysisMode(mode="binary", binary="./snsweep-main2d", func="solve_")
...
func_node = bgt.getNodeWithUniqueId(psg.main_root, 556794, random.randint(0,100000))
